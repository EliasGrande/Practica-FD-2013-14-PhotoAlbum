...
public class DaoTest {
	...
	public void testGetAlbumSharedWith (){
		...
		AlbumShareInformation asi = new AlbumShareInformation(null,album,user2);
		this.albumShareInformationService.create(asi);
		AlbumShareInformation asi2 = new AlbumShareInformation(null,album2,user2);
		this.albumShareInformationService.create(asi2);
		
		ArrayList<Album> list = this.albumService.getAlbumsSharedWith(user2.getId(), user.getEmail());
		ArrayList<Album> list2 = this.albumService.getAlbumsSharedWith(user.getId(), user2.getEmail());
	...
	public void testGetSharedAlbum(){
		...
		Album alSha = this.albumService.getSharedAlbum(album.getName(), user2.getId(), user.getEmail());
		
		assertEquals(alSha,album);
		
		this.albumShareInformationService.delete(asi);
		
		Album alSha2 = this.albumService.getSharedAlbum(album.getName(), user2.getId(), user.getEmail());
	...
	public void testGetFileOwn(){
		...
		File fileOwn = this.fileService.getFileOwn(file.getId(), album.getName(), user.getId());
		
		assertEquals(fileOwn,file);
		
		File fileOwn2 = this.fileService.getFileOwn(file.getId(), album.getName(), user2.getId());
	...
	public void testGetFileshared(){
		...
		this.fileShareInformationService.create(fsi);
		AlbumShareInformation asi = new AlbumShareInformation(null,album2,user);
		this.albumShareInformationService.create(asi);
		
		File fileShared = this.fileService.getFileShared(file2.getId(), album.getName(), user2.getId());
		File fileShared2 = this.fileService.getFileShared(file4.getId(), album.getName(), user.getId());
		File fileShared3 = this.fileService.getFileShared(file.getId(), album.getName(), user3.getId());
		File fileShared4 = this.fileService.getFileShared(file3.getId(), null, user3.getId());
	...
	public void testGetFilePublic(){
		...
		File filePublic = this.fileService.getFilePublic(file.getId(), album.getName(), user.getId());
		File filePublic2 = this.fileService.getFilePublic(file.getId(), album.getName(), user2.getId());
		File filePublic3 = this.fileService.getFilePublic(file2.getId(), album.getName(), user2.getId());
	...
	public void testGetAlbumFilesOwn(){
		...
		ArrayList<File> filesOwn = this.fileService.getAlbumFilesOwn(album.getId());
	...
	public void testGetAlbumFilesOwnPaging(){
		...
		ArrayList<File> filesOwn = this.fileService.getAlbumFilesOwnPaging(album.getId(),0,2);
		ArrayList<File> filesOwn2 = this.fileService.getAlbumFilesOwnPaging(album.getId(),2,1);
	...
	public void testGetAlbumFilesShared(){
		...
		ArrayList<File> filesShared = this.fileService.getAlbumFilesShared(album.getId(), user2.getId());
		ArrayList<File> filesShared2 = this.fileService.getAlbumFilesShared(album2.getId(), user2.getId());
	...
	public void testGetAlbumFilesSharedPaging(){
		...
		ArrayList<File> filesShared = this.fileService.getAlbumFilesSharedPaging(album.getId(), user2.getId(),0,1);
		ArrayList<File> filesShared2 = this.fileService.getAlbumFilesSharedPaging(album.getId(), user2.getId(),1,1);
	...
	public void getAlbumFilesPublic(){
		...
		ArrayList<File> filesPublic = this.fileService.getAlbumFilesPublic(album.getId(), user.getId());
		ArrayList<File> filesPublic2 = this.fileService.getAlbumFilesPublic(album.getId(), user2.getId());
		...
		ArrayList<File> filesPublic3 = this.fileService.getAlbumFilesPublic(album.getId(), user2.getId());
	...
	public void getAlbumFilesPublicPaging(){
		...
		ArrayList<File> filesPublic = this.fileService.getAlbumFilesPublicPaging(album.getId(), user.getId(),0,2);
		ArrayList<File> filesPublic2 = this.fileService.getAlbumFilesPublicPaging(album.getId(), user2.getId(),2,1);
