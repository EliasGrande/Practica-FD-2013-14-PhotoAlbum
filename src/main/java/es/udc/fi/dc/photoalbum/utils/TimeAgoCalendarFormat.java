...
public class TimeAgoCalendarFormat implements Serializable {
	...
	private String timeAgo(long unitsAgo, String unitName) {
		return (unitsAgo<=1)
				? new StringResourceModel("timeAgo."+unitName+".one", component, null)
						.getString()
				: new StringResourceModel("timeAgo."+unitName+".many", component, null)
						.getString().replace("%l",  String.valueOf(unitsAgo));
	}
}
