...
public class RandomDataGenerator {
    ...
    private static final String LOREN_IPSUM_SIMPLE = LOREN_IPSUM.replaceAll(
            "[^a-z]", "");
    ...
    public static Comment randomComment(File file) {
        Comment comment = new Comment(randomLikeAndDislike(), randomUser(),
                randomText(), null, file);
        comment.setId(++id);
