...
public interface CommentService {
	 ...
	 * Create a comment.
	 * 
	 * @param userThatComment User thar create the comment.
	 * @param album Album that owns the comment.
	 * @param text The text that contains the comment.
	 */
	 ...
	 * 
	 * @param userThatComment User thar create the comment.
	 * @param file File that owns the comment.
	 * @param text The text that contains the comment.
	 */
	 ...
	 * Delete a comment.
	 * 
	 * @param comment Comment that will be deleted.
	 */
	 ...
	 * 
	 * @param album It's the album they belong comments.
	 ...
	 * 
	 * @param file It's the file they belong comments.
	 ...
	 * 
	 * @param album It's the album they belong comments.
	 * @param first The first element that obtains.
	 * @param count The number of elements that will be obtains.
	 * @return ArrayList<Comment> A list of album comments.
	 */
