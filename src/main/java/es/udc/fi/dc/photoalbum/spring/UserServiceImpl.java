...
public class UserServiceImpl implements UserService {
     ...
     * @see es.udc.fi.dc.photoalbum.spring.UserService#getUser(String,
     *      String)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.UserService#getUser(User)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.UserService#getUsersSharingWith(int)
     */
