...
public class FileServiceImpl implements FileService {
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getFileOwn(int,
     *      String, int)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#changeAlbum(File,
     *      Album)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesOwn(int)
     */
     ...
     * @return List of files that belongs to an {@link Album}.
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesOwnPaging(int,
     *      int, int)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#changePrivacyLevel(File,
     *      String)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getFilePublic(int,
     *      String, int)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesShared(int,
     *      int)
     */
     ...
     *            The number of elements that will be obtained.
     * @return A list of files which have been shared.
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesSharedPaging(int,
     *      int, int, int)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesPublic(int,
     *      int)
     */
     ...
     *            The number of elements that will be obtained.
     * @return A list of files whose privacy level is public.
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getAlbumFilesPublicPaging(int,
     *      int, int, int)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getFilesByTag(int,
     *      String)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileService#getFilesByTagPaging(int,
     *      String, int, int)
     */
