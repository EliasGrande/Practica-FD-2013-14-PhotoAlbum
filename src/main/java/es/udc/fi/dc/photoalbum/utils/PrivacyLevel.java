...
public class PrivacyLevel {
	 ...
	 */
	public static final List<String> LIST_ALBUM = Arrays.asList(new String[] {
			PRIVATE, PUBLIC });
	
	/**
	 * Lista de valores posibles de nivel de privacidad para archivos.
	 */
	public static final List<String> LIST_FILE = Arrays.asList(new String[] {
			PRIVATE, PUBLIC, INHERIT_FROM_ALBUM });

	/**
	 * Comprueba que el valor de privacidad indicado está entre los posibles
	 * para un álbum. Útil en validacion de formularios.
	 */
	...
	/**
	 * Comprueba que el valor de privacidad indicado está entre los posibles
	 * para un archivo. Útil en validacion de formularios.
	 */
