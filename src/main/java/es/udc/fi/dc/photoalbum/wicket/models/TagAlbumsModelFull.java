...
public class TagAlbumsModelFull extends LoadableDetachableModel<ArrayList<Album>> {
	...
	protected ArrayList<Album> load() {
		ArrayList<Album> list = new ArrayList<Album>(albumService.getAlbumsByTag(userId, tag));
