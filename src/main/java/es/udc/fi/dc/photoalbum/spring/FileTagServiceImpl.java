...
public class FileTagServiceImpl implements FileTagService {
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileTagService#create(FileTag)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileTagService#delete(FileTag)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.spring.FileTagService#getTag(int,
     *      String)
     */
     ...
     *         is the {@link File} id.
     * @see es.udc.fi.dc.photoalbum.spring.FileTagService#getTags(int)
     */
