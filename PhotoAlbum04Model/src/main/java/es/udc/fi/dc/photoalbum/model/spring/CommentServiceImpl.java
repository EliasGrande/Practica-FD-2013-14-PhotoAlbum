...
import es.udc.fi.dc.photoalbum.model.hibernate.AlbumTagDao;
import es.udc.fi.dc.photoalbum.model.hibernate.Comment;
import es.udc.fi.dc.photoalbum.model.hibernate.CommentDao;
...
public class CommentServiceImpl implements CommentService {
     ...
     * 
     * @see es.udc.fi.dc.photoalbum.model.spring.CommentService#create(User,
     *      Album, String)
     */
     ...
     * 
     * @see es.udc.fi.dc.photoalbum.model.spring.CommentService#delete(Comment)
     */
     ...
     * 
     * @see es.udc.fi.dc.photoalbum.model.spring.CommentService#
     *      getComments(Album)
     */
