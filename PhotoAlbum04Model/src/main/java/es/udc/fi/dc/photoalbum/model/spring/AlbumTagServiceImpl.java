...
public class AlbumTagServiceImpl implements AlbumTagService {
     ...
     * 
     * @see es.udc.fi.dc.photoalbum.model.spring.AlbumTagService#create(AlbumTag)
     */
     ...
     * 
     * @see es.udc.fi.dc.photoalbum.model.spring.AlbumTagService#delete(AlbumTag)
     */
     ...
     *         that name * @see
     *         es.udc.fi.dc.photoalbum.model.spring.AlbumTagService
     *         #getTag(int, String)
     */
