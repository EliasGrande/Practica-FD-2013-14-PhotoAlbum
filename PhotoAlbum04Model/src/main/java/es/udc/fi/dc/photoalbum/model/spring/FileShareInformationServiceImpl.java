...
public class FileShareInformationServiceImpl implements
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.FileShareInformationService#create(FileShareInformation)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.FileShareInformationService#delete(FileShareInformation)
     */
     ...
     *         {@link File}.
     * @see es.udc.fi.dc.photoalbum.model.spring.FileShareInformationService#getFileShares(int)
     */
