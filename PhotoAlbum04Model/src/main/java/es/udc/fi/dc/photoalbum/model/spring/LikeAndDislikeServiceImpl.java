...
public class LikeAndDislikeServiceImpl implements
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.LikeAndDislikeService#voteLike(LikeAndDislike,
     *      User)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.LikeAndDislikeService#voteDislike(LikeAndDislike,
     *      User)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.LikeAndDislikeService#unvote(LikeAndDislike,
     *      User)
     */
     ...
     * @see es.udc.fi.dc.photoalbum.model.spring.LikeAndDislikeService#userHasVoted(LikeAndDislike,
     *      User)
     */
